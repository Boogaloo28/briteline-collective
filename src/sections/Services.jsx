...
const SERVICES = [
  ...
  { icon:"△", color:"#6B7FA3",tag:"Mental Health",        title:"Mental Health First Aid",
    ...
    price:"$250/person" },
  { icon:"□", color:C.forest, tag:"Peer Support",         title:"Peer Support Consulting",
    desc:"A decade-plus of certified peer support experience — eight years inside Pennsylvania correctional facilities and five years on reentry. Lee and Dennis are also PA DOC CIT Trainers. For individuals navigating reentry, recovery, or trauma — and for institutions building peer support capacity.",
